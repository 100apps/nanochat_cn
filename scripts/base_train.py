...
save_every = os.environ.get("NANOCHAT_BASE_TRAIN_SAVE_EVERY") if os.environ.get("NANOCHAT_BASE_TRAIN_SAVE_EVERY") else -1 # every how many steps to save model checkpoints (-1 = disable, and save only at the end of the run)
# Output
